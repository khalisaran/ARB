...
import com.AssetRegisterBook.domain.core.AsUser;
 ...
 *
*/
public class AsBaseController {

	private AsUser theUser;
	...
	public AsUser getUser(){
		...
		if (authentication != null) {
			...
			if (principal instanceof AsUser) {
				theUser = (AsUser) principal;
