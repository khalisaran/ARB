...
@ApiModel( value = "Currency", description = "Currency" )
...
@JsonProperty("currenyname")
	...
	@ApiModelProperty( value = "description", required = true )
@JsonProperty("currenydescription")
	@Field("CurrenyDescription")
 	private	String CurrenyDescription;
	...
	public void setCurrenyDescription(String CurrenyDescription) {
		this.CurrenyDescription = CurrenyDescription;
	}


	public String getCurrenyDescription() {
		return CurrenyDescription;
	}
