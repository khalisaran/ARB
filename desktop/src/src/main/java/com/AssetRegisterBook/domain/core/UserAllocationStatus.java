...
@Document
@TypeAlias("userallocationstatus")

@ApiModel( value = "UserAllocationStatus", description = "UserAllocationStatus" )
public class UserAllocationStatus  implements Serializable  {
