...
@Document
@TypeAlias("approverorprojectmanager")

@ApiModel( value = "ApproverOrProjectManager", description = "ApproverOrProjectManager" )
public class ApproverOrProjectManager  implements Serializable  {
